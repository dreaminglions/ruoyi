...
public class SysRoleController extends BaseController
{
    ...
    @Log(title = "导出角色信息", businessType = BusinessType.EXPORT)
     ...
     * 取消授权
     */
    @Log(title = "取消角色授权", businessType = BusinessType.GRANT)
     ...
     * 批量取消授权
     */
    @Log(title = "批量取消角色授权", businessType = BusinessType.GRANT)
     ...
     * 批量选择用户授权
     */
    @Log(title = "批量选择用户角色授权", businessType = BusinessType.GRANT)
