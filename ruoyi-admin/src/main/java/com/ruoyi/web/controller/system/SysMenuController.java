...
public class SysMenuController extends BaseController
{
     ...
     * 删除菜单
     */
    @Log(title = "菜单管理(删除项)", businessType = BusinessType.DELETE)
     ...
     * 新增保存菜单
     */
    @Log(title = "菜单管理(新增项)", businessType = BusinessType.INSERT)
     ...
     * 修改保存菜单
     */
    @Log(title = "菜单管理(修改项)", businessType = BusinessType.UPDATE)
